  ...
  <body>
    ...
    <div class="row">    
            <div class="col col-xs col-md">
                <label for="">ID_Direccion</label>
                <input required class="form-control" type="number" name="ID_Direccion" value="" >
            </div>
    </div>    
    <div class="row">
            <div class="col col-xs col-md">
        ...
        <div class="row"> 
           <div class="col col-xs col-md">
                ...
                <input required class="form-control" type="number" name="No_interior" value="" >
            </div> 
            <div class="col col-xs col-md">
                <label for="">No_exterior</label>
                <input required class="form-control" type="number" name="No_exterior" value="" >
            </div> 
        </div>         
        <br>
        <div class="row">
